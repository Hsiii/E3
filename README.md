...
## About the 2FA
Currently, the 2FA authentication that the portal sometimes requires still needs to be done manually, but the extension will finish the rest of the process to navigate to E3.